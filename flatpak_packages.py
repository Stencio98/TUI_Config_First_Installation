programs = {
	"📦 flatpak packages:": {
		...
		"kate editor": "flatpak install -y flathub org.kde.kate"
    	        "discord": "flatpak install -y flathub com.discordapp.Discord",
    	        "chromium": "flatpak install -y flathub org.chromium.Chromium",
                "Intellij Community": "flatpak install -y flathub com.jetbrains.IntelliJ-IDEA-Community",
    	        "Android Studio": "flatpak install -y flathub com.google.AndroidStudio",
    	        ...
    	        "0ad": "flatpak install -y flathub com.play0ad.zeroad"
	}
}
