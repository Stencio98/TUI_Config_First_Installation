programs = {
    ...
    "🔄 update flatpak packages (⚠️ you need flatpak installed -- 🛠️ flatpak)": "sudo flatpak update",
    ...
    "⚙️ install snapd and snap store gui (🛠️ apt and snapd)": "sudo apt install snapd && sudo snap install snapd && sudo snap install snap-store"
